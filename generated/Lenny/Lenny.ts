...
export class Lenny__checkpointsResultValue0Struct extends ethereum.Tuple {
...
export class Lenny extends ethereum.SmartContract {
  static bind(address: Address): Lenny {
    return new Lenny("Lenny", address);
  }
  ...
  checkpoints(
    account: Address,
    pos: BigInt
  ): Lenny__checkpointsResultValue0Struct {
    let result = super.call(
      "checkpoints",
    ...
    return changetype<Lenny__checkpointsResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_checkpoints(
    account: Address,
    pos: BigInt
  ): ethereum.CallResult<Lenny__checkpointsResultValue0Struct> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):((uint32,uint224))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<Lenny__checkpointsResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  isExcludedFromMaxToken(account: Address): boolean {
    let result = super.call(
      "isExcludedFromMaxToken",
      "isExcludedFromMaxToken(address):(bool)",
      [ethereum.Value.fromAddress(account)]
    );
  ...
  try_isExcludedFromMaxToken(account: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "isExcludedFromMaxToken",
      "isExcludedFromMaxToken(address):(bool)",
      [ethereum.Value.fromAddress(account)]
  ...
  maxTokenPerAddress(): BigInt {
    let result = super.call(
      "maxTokenPerAddress",
      "maxTokenPerAddress():(uint256)",
      []
    );
  ...
  try_maxTokenPerAddress(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "maxTokenPerAddress",
      "maxTokenPerAddress():(uint256)",
      []
...
export class ConstructorCall__Inputs {
  ...
  get _maxTokenPerAddress(): BigInt {
...
export class ExcludeFromMaxTokenCall extends ethereum.Call {
  get inputs(): ExcludeFromMaxTokenCall__Inputs {
    return new ExcludeFromMaxTokenCall__Inputs(this);
  }

  get outputs(): ExcludeFromMaxTokenCall__Outputs {
    return new ExcludeFromMaxTokenCall__Outputs(this);
  }
}

export class ExcludeFromMaxTokenCall__Inputs {
  _call: ExcludeFromMaxTokenCall;

  constructor(call: ExcludeFromMaxTokenCall) {
    this._call = call;
  }
...
export class ExcludeFromMaxTokenCall__Outputs {
  _call: ExcludeFromMaxTokenCall;
...
export class IncludeInMaxTokenCall extends ethereum.Call {
  get inputs(): IncludeInMaxTokenCall__Inputs {
    return new IncludeInMaxTokenCall__Inputs(this);
  }

  get outputs(): IncludeInMaxTokenCall__Outputs {
    return new IncludeInMaxTokenCall__Outputs(this);
  }
}

export class IncludeInMaxTokenCall__Inputs {
  _call: IncludeInMaxTokenCall;

  constructor(call: IncludeInMaxTokenCall) {
    this._call = call;
  }
...
export class IncludeInMaxTokenCall__Outputs {
  _call: IncludeInMaxTokenCall;
...
export class SetMaxTokenPerAddressCall extends ethereum.Call {
  get inputs(): SetMaxTokenPerAddressCall__Inputs {
    return new SetMaxTokenPerAddressCall__Inputs(this);
  }

  get outputs(): SetMaxTokenPerAddressCall__Outputs {
    return new SetMaxTokenPerAddressCall__Outputs(this);
  }
}

export class SetMaxTokenPerAddressCall__Inputs {
  _call: SetMaxTokenPerAddressCall;

  constructor(call: SetMaxTokenPerAddressCall) {
    this._call = call;
  }

  get _maxToken(): BigInt {
    return this._call.inputValues[0].value.toBigInt();
  }
}

export class SetMaxTokenPerAddressCall__Outputs {
  _call: SetMaxTokenPerAddressCall;
